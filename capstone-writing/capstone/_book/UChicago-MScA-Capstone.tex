...
\caption{museGen Model Structure}\label{fig:unnamed-chunk-5}
\end{figure}
...
\caption{museGen Model Structure}\label{fig:unnamed-chunk-6}
\end{figure}
...
\caption{museGen Model Structure}\label{fig:unnamed-chunk-7}
\end{figure}
...
\caption{Training Loss Graph}\label{fig:unnamed-chunk-9}
\end{figure}
