...
```{r, out.width="0.3\\linewidth", include=TRUE, fig.align="center", fig.cap=c("Loss Graph, 512 Nodes"), echo=FALSE}
...
```{r, out.width="0.3\\linewidth", include=TRUE, fig.align="center", fig.cap=c("Loss Graph, Extra Dense Layer"), echo=FALSE}
...
```{r, out.width="0.3\\linewidth", include=TRUE, fig.align="center", fig.cap=c("Loss Graph, Pitch Generator"), echo=FALSE}
knitr::include_graphics("figure/ap_newmod_pitch.png")
```

```{r, out.width="0.3\\linewidth", include=TRUE, fig.align="center", fig.cap=c("Loss Graph, Duration Generator"), echo=FALSE}
...
```{r, out.width="0.3\\linewidth", include=TRUE, fig.align="center", fig.cap=c("Loss Graph, 30 Note Training Samples"), echo=FALSE}
