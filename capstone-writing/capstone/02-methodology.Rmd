...
```{r, out.width="0.8\\linewidth", include=TRUE, fig.align="center", fig.cap=c("museGen Model Structure"), echo=FALSE}
...
[^1]: For our discriminator model this is necessary, but there are other model structures available to overcome this problem.
...
[^2]: See Generative adversarial network, Wikipedia. https://en.wikipedia.org/wiki/Generative_adversarial_network

### Generator {.unnumbered}

Our generator is a deep neural network with the following basic structure:

```{r, out.width="0.3\\linewidth", include=TRUE, fig.align="center", fig.cap=c("museGen Model Structure"), echo=FALSE}
knitr::include_graphics("figure/model_terryjosh.png")
```
...
**Insert Discriminator model image here**
