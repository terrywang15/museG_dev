...
from tensorflow.keras.layers import Dense, concatenate, BatchNormalization, Input, ReLU
from tensorflow.keras.layers import Reshape
from tensorflow.keras.layers import Flatten
from tensorflow.keras.layers import Dropout, Softmax
from pretty_midi_musGen import PrettyMIDI, Instrument, Note
from pretty_midi_musGen.musGen_utils import make_midi2
...
# Changes:
# 1) Accomodated number of notes in training sample to be 30


# Discriminator
def define_discriminator(in_shape=(30, 130)):
    """
...
def define_generator(latent_dim, dropout_rate, num_nodes):
    ...
    pitch = Dense(30 * 128)(pitch2)
    duration = Dense(30 * 2)(duration2)

    pitch_reshaped = Reshape((30, 128))(pitch)

    duration_reshaped = Reshape((30, 2))(duration)
...
def train(g_model, d_model, gan_model, dataset, latent_dim, n_epochs=100, n_batch=128):
    ...
    for i in range(n_epochs):
        ...
        if i % 50 == 0:
            ...
            make_midi2(pred, ts_str + "/ep_" + str(i) + ".mid")
...
# load training data
train_fp = "training_samples/sample_2020-03-08-21-25.npy"
dataset = np.load(train_fp, allow_pickle=True)
# Make timestamp
